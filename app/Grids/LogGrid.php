...
class LogGrid extends Grid implements LogGridInterface
{
    /**
    ...
    */
        ...
        $this->columns = [
            ...
            "user_id" => [
                ...
                'presenter' => function ($columnData, $columnName) {
                    return $columnData->user->name;
                },
                'filter' => [
                    'enabled' => true,
                    'type' => 'select',
                    'data' => User::query()->pluck('name', 'id')
                ]
            ],
            "action_id" => [
                'label' => 'Действие',
                ...
                'search' => ['enabled' => false],
                'presenter' => function ($columnData, $columnName) {
                    //return $columnData->logAction->name;
                    return $columnData->action->name;
                },
                'filter' => [
                    'enabled' => true,
                    'type' => 'select',
                    'data' => Action::query()->pluck('name', 'id')
                ]
            ],
        ];
    }
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('log.index');
